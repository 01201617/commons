...
# from common import fileoperation_csv_v1_0
...
# まとめてパッキング！(分けても良いが)
[widget.pack() for widget in (listbox_todo, listbox_done, button_copy, button_pop, button_delete, scrollbar,
                              en_todo, button_delete_done)]
