...
if __name__ == '__main__':
    ...
    # [1] インスタンス化
    ae = Autoencoder(in_dim=784, h_dim1=hidden_size_1, h_dim2=hidden_size_2)
    ...
    torchvision.utils.save_image(Variable(fixed_x).data.cpu(), './data/data_3layers/real_images.png')
    ...
    for epoch in range(num_epochs):
        ...
        torchvision.utils.save_image(reconst_images.data.cpu(), './data/data_3layers/reconst_images_%d.png' % (epoch+1))